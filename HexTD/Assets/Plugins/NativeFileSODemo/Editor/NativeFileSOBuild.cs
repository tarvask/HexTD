...
namespace Plugins.NativeFileSODemo.Editor
{
...
//	}
		...
		public static void UpdateAndroidPlugin() {
			...
			ZipStorer.ZipStorer zip = ZipStorer.ZipStorer.Open(aarPath, FileAccess.ReadWrite);
			...
			ZipStorer.ZipStorer.RemoveEntries(ref zip, new List<ZipStorer.ZipStorer.ZipFileEntry>() { 
				manifest });
			zip.AddFile(ZipStorer.ZipStorer.Compression.Deflate, manifestPath, manifest.FilenameInZip, "");
