...
{
    public abstract class StableBuffParameters : AbstractBuffParameters
    {
        ...
        public override bool IsProgressive => false;

        protected StableBuffParameters(string buffName,
