...
{
    public abstract class WaveMobSpawnerBaseWithReinforcements : BaseDisposable, IOuterLogicUpdatable
    {
        public struct Context
        {
            ...
            public WaveParametersWithChances[] Waves { get; }
            ...
            public Context(
                ...
                WaveParametersWithChances[] waves,
                bool isMultiPlayer,
        ...
        protected WaveMobSpawnerBaseWithReinforcements(Context context)
        {
            _context = context;
