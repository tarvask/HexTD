...
namespace Addressables
{
	...
	{
		private readonly Dictionary<string, AsyncOperationHandle<SpriteAtlas>> loadedAtlasHandles =
			new Dictionary<string, AsyncOperationHandle<SpriteAtlas>>();

		private readonly Dictionary<string, AsyncOperationHandle<Sprite>> loadedSpriteHandles =
