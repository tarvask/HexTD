...
namespace Addressables
{
	public sealed class AddressableParallaxPool
	{
		...
		public AddressableParallaxPool(DiContainer container,
			List<IAddressableAssetsReferencesProvider> assetsReferencesProviders)
		{
...
#if UNITY_EDITOR
				Debug.LogError(
					$"Not found Prefab with reference - {reference.editorAsset.name} Load default parallax tile!");
#endif
			}
