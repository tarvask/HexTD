    ...
    public abstract class SecureTestsImpl : LoadBalancingUnifiedTestsBase
    {
        ...
        public void SecureParamsTest()
        {
            ...
            try
            {
                ...
                this.ConnectAndAuthenticate(client,
                    (string)response[ParameterCode.Address], client.UserId,
                    new Dictionary<byte, object>
                    {
                        {(byte)ParameterKey.ClientAuthenticationParams, "username=yes&token=yes"}
                    });
        ...
        {
            var httpWebRequest = (HttpWebRequest)WebRequest.Create("https://wt-e4c18d407aa73a40e4182aaf00a2a2eb-0.run.webtask.io/realtime-webhooks-1.2/CheckSecure");
