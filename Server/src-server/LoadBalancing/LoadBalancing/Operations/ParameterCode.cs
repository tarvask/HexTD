...
namespace Photon.LoadBalancing.Operations
{
    public enum ParameterCode : byte
    {
        ...
        CloudType = Photon.Hive.Operations.ParameterKey.CloudType,
        GameRemoveReason = Photon.Hive.Operations.ParameterKey.GameRemoveReason,
//        CustomInitData = Photon.Hive.Operations.ParameterKey.CustomInitData,
    }
}