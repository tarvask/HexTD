...
namespace Photon.LoadBalancing.Operations
{
    public enum OperationCode : byte
    {
        ...
        AuthOnce = Photon.Hive.Operations.OperationCode.AuthOnce,
        ...
        Settings = Photon.Hive.Operations.OperationCode.Settings,
        GetGameList = Photon.Hive.Operations.OperationCode.GetGameList,
        LoadBalancingMin = Rpc - 10,
    }
}