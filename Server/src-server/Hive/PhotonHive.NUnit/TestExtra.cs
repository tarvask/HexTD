...
namespace Photon.Hive.Tests
{
    ...
    public class TestGameCache : Caching.RoomCacheBase
    {
        ...
        {
            return new TestGame(new GameCreateOptions(roomId, this, PluginManager, 1000, new TestGame.TestGameStateFactory()));
        }
    }
    ...
    public class TestGame : HiveHostGame
    {
        ...
        public class TestGameStateFactory : IGameStateFactory
        {
        ...
        public TestGame(GameCreateOptions gameCreateOptions)
            : base(gameCreateOptions)
        {
        }
        ...
        {
            return (TestPlugin)this.PluginInstance.Plugin;
        }
    ...
    public class TestHivePeer : HivePeer
    {
        ...
        public void SetHttpRpcCallsLimit(int value)
        {
            this.HttpRpcCallsLimit = value;
        }

        public Room LastCreatedRoom { get; private set; }
        ...
        {
            var roomRef = TestGameCache.Instance.GetRoomReference(gameId, this);
            this.LastCreatedRoom = roomRef.Room;
            return roomRef;
        }
