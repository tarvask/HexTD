...
namespace Photon.Hive
{
    ...
    public class Actor : IActor
    {
        ...
        {
            return String.Format("Actor: {0}; Peer:'{1}', DeactivationTime:'{2}', UserId:'{3}',nick:'{4}', RemovedFromInactive:{5}", 
                this.ActorNr, this.Peer, this.DeactivationTime, this.UserId, this.Nickname, this.RemovedFromInactive);
        }
