...
namespace Photon.Hive.Plugin
{
    ...
    public class PluginBase : IGamePlugin
    {
        ...
        public IPluginHost PluginHost
        {
            ...
            protected set
            {
                this.pluginHost = value ?? throw new ArgumentException("PluginHost can not be set to null");
            }
        }
        ...
        public string AppVersion
        {
            get
            {
                ...
                if (this.PluginHost.Environment == null)
                {
                    return string.Empty;
                }
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            System.Diagnostics.Debug.Assert(!this.fireAssert || this.PluginHost != null);
            info.Continue();
        }
        ...
        {
            System.Diagnostics.Debug.Assert(!fireAssert || this.PluginHost != null);
            info.Continue();
        }
#endif
        /// <summary>
        ...
        /// </summary>
        /// <param name="info">Data passed in the callback call.</param>
        [Obsolete("this method is not used by our code")]
        ...
        [Obsolete("do not use. does nothing")]
