...
namespace TestPlugins
{
    class BasicTestsPlugin : PluginBase
    {
        ...
        {
            Assert.That(this.PluginHost.GameId, Is.Not.Null.Or.Empty);
            Assert.AreEqual("TestGame", this.PluginHost.GameId);
        ...
        private static void CheckIJoinGameRequest(IJoinGameRequest request)
        {
            ...
            Assert.That(request.GameId, Is.Not.Null.Or.Empty);
        }
        ...
        private void CheckIRaiseEventCallInfo(IRaiseEventCallInfo info)
        {
            ...
            if (info.Request.EvCode == 5)
            {
                ...
                Assert.That(info.Request.GameId, Is.Not.Null.Or.Empty);
